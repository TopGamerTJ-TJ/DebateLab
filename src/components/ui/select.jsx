...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => {
  ...
  const classes = cn(
    "flex h-9 min-h-[44px] md:min-h-0 w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-transparent px-3 py-2 text-sm text-slate-900 dark:text-slate-100 shadow-sm ring-offset-background data-[placeholder]:text-[#616161] dark:data-[placeholder]:text-[#616161] focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 active:opacity-70",
    className
  )
