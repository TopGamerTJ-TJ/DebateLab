    ...
    <div className="min-h-[100dvh] flex bg-gradient-to-br from-slate-900 to-blue-950">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-card text-card-foreground rounded-2xl shadow-xl border border-border p-8 [&_.google-btn]:border-border [&_.google-btn]:text-foreground [&_.google-btn]:hover:bg-accent [&_.or-divider]:border-border [&_.or-label]:bg-card [&_.or-label]:text-muted-foreground">
            {children}
          </div>
          {footer && (
