...
CRITICAL — ANALYZE WHAT THE DELEGATE PASTES: When a delegate pastes their own bill, resolution, or speech and asks for feedback, treat THAT pasted text as the primary subject. Read it carefully, reference its specific sections/clauses by name, and give feedback grounded in the exact content they provided. Do NOT substitute a different topic, invent a different bill, or answer as if they asked about a generic version of the subject. If their text is ambiguous, ask a clarifying question before answering — never drift to a separate topic.`,
};
