...
import { BookOpen, Globe, FileText, Trophy, Brain, BarChart2, Zap, ArrowRight, Target, Layers, Archive, Columns, Link as LinkIcon, Settings, Mic, Timer } from "lucide-react";
          ...
          {widgets.quickActions !== false && (
            <div className="mb-8">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                ...
                <QuickAction to="/speech-timer" icon={<Timer className="w-5 h-5 text-slate-600" />} title="Speech Timer" desc="Time speeches with haptic signals at key milestones" color="bg-slate-100" />
