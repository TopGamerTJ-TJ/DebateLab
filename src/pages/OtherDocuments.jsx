    ...
    <AnimatedPage>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-28 lg:pb-8">
        <div className="bg-gradient-to-br from-violet-600 to-violet-700 rounded-3xl p-8 mb-8 text-white shadow-lg">
          ...
          <p className="text-violet-100 max-w-2xl">Generate any document you need that isn't covered by the dedicated sections — describe it, and the AI builds it. Or prep for Q&A using your existing docs. Save your documents to projects and find them in the project's "All Docs" tab.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm flex flex-col">
          ...
          {docs.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center py-12">
              ...
              <p className="text-slate-400 text-xs mt-1">Describe what you need above to generate your first one.</p>
            </div>
          ) : (
